 ...
 */
public class MasterCategoryListAdapter extends RecyclerView.Adapter<MasterCategoryListAdapter.MyViewHolder> {
    ...
    private static final String TAG = MasterCategoryListAdapter.class.getSimpleName();
    ...
    public MasterCategoryListAdapter(Context context, List<Category> data, boolean isType) {
        this.mData = data;
