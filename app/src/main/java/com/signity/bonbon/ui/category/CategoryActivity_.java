...
public class CategoryActivity_ extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appVersion.equals(olderVersion)) {
            if (listCategory != null && listCategory.size() != 0) {
                adapter = new GridViewAdapter(CategoryActivity_.this, listCategory);
    ...
    public void getCategoryList() {
        ...
        ProgressDialogUtil.showProgressDialog(CategoryActivity_.this);
        ...
        NetworkAdaper.getInstance().getNetworkServices().getCategoryList(new Callback<GetCategory>() {
            ...
            public void failure(RetrofitError error) {
                ProgressDialogUtil.hideProgressDialog();
                DialogHandler dialogHandler = new DialogHandler(CategoryActivity_.this);
...
//            holder.image.setImageResource(images[0]);
            ...
            if (category.getImageMedium() != null && !category.getImageMedium().isEmpty()) {
                Picasso.with(CategoryActivity_.this).load(category.getImage()).
...
//            holder.image.setImageResource(images[new Random(images.length).nextInt() - 1]);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (category.getSubCategoryList() != null && category.getSubCategoryList().size() != 0) {
                        ...
                        Intent i = new Intent(CategoryActivity_.this, viewController.getCategoryDetailActivity());
                        i.putExtra("categoryId", category.getId());
                        i.putExtra("title", category.getTitle());

                        startActivity(i);
                        AnimUtil.slideFromRightAnim(CategoryActivity_.this);
                    } else {
                        showAlertDialog(CategoryActivity_.this, "Alert", "No Subcategories available");
                    }
                }
            });
            return convertView;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        AnimUtil.slideFromLeftAnim(CategoryActivity_.this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.backButton:
                ...
                break;
            case R.id.btnSearch:
                startActivity(new Intent(CategoryActivity_.this, AppController.getInstance().getViewController().getSearchActivity()));
                AnimUtil.slideFromRightAnim(CategoryActivity_.this);
                break;
